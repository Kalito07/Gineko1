...
function TabNavigator() {
    ...
    const handleLogout = () => {
        ...
        setLogoutModalVisible(false);  // Close the modal after confirming logout
    };
    ...
    return (
        <>
            ...
            >
                ...
                <Tab.Screen
                    name="logout"
                    component={() => null}  // Empty component as logout is handled in listeners
            ...
            <Message
                ...
                onClose={() => setLogoutModalVisible(false)}
                label={message}
                onConfirm={handleLogout}  // Pass the logout handler here
            />
        </>
    );
}
